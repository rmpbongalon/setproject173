        ...
        <>
            ...
            <center>
                <div className="category">
                    <br/>
                    <h1 className="category-heading"> Part I: Preparedness</h1><br/>
                ...
                <div className="category">
                    <h1 className="category-heading"> Part II: Student-Faculty Relationship</h1><br/>
                    <div className="formCard">
                ...
                <div className="category">
                    <h1 className="category-heading"> Part III: Time Management</h1><br/>
                    <div className="formCard">
                ...
                <div className="category">
                    <h1 className="category-heading"> Part IV: Quality of Requirements</h1><br/>
                    <div className="formCard">
